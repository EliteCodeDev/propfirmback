...
import { jwtConfig, intercomConfig } from '../../config';
...
@Module({
  imports: [
    ...
    ConfigModule.forFeature(intercomConfig),
    JwtModule.registerAsync(jwtConfig),
    MailerModule,
    PasswordResetModule,
  ],
  providers: [AuthService, LocalStrategy, JwtStrategy, TurnstileService, TurnstileGuard, IntercomService],
